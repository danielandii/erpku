    ...
    public function run(): void
    {
        ...
        foreach ($users as $u) {
            ...
            DB::table('user_roles')->insertOrIgnore([
                ...
                'user_id'     => $u['id'],
                'role_id'     => $u['role_id'],
                'assigned_by' => '22222222-2222-2222-2222-00000000000001',
                'assigned_at' => $now,
                'created_at'  => $now,
                'updated_at'  => $now,
            ]);
